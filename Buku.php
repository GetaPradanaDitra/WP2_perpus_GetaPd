...
'required|min length [3]', [
        ...
        $this->form validation->set_rules('tahun', 'Tahun Terbit', 'required|min_length[3]|max_length[4]|numeric', [
            'required' => 'Tahun terbit harus diisi',
            'min_length' => 'Tahun terbit terlalu pendek',
            'max_length' => 'Tahun terbit terlalu panjang',
            'numeric' => 'Hanya boleh diisi angka'
        ]);
        $this->form validation->set_rules('isbn', 'Nomor ISBN', 'required|min_length[3]|numeric', [
            ...
            if ($this->form_validation->run() == false) { 
                ...
                $data = [
                    'judul buku' => $this->input->post('judul buku', true),
                    'id kategori' => $this->input->post('id_kategori',true),
